...
mex -g COMPFLAGS='$COMPFLAGS -O2' -LC:\PROGRA~1\NVIDIA~2\CUDA\v12.3\lib\x64\ -IC:\PROGRA~1\NVIDIA~2\CUDA\v12.3\include\ -lOpenCL src\cl_get_devices.cpp src\ocl_dev_mgr.cpp
mex -g COMPFLAGS='$COMPFLAGS -O2' -LC:\PROGRA~1\NVIDIA~2\CUDA\v12.3\lib\x64\ -IC:\PROGRA~1\NVIDIA~2\CUDA\v12.3\include\ -lOpenCL src\cl_run_kernel.cpp src\ocl_dev_mgr.cpp
mex -g COMPFLAGS='$COMPFLAGS -O2' -LC:\PROGRA~1\NVIDIA~2\CUDA\v12.3\lib\x64\ -IC:\PROGRA~1\NVIDIA~2\CUDA\v12.3\include\ -lOpenCL src\cl_dbg_kernel.cpp src\ocl_dev_mgr.cpp
